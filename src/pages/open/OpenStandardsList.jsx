...
import { AcademicCapIcon, ChevronRightIcon, UserGroupIcon } from '@heroicons/react/24/outline';
import LoadingSpinner from '../../components/common/LoadingSpinner';

const OpenStandardsList = () => {
  ...
  if (isLoading && standards.length === 0) return <LoadingSpinner />;
...
export default OpenStandardsList;
