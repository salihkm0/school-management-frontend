  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-md bg-white rounded-xl shadow-sm p-6 space-y-4">
        ...
        <div><label className="block text-sm font-medium text-gray-700 mb-1">Year</label><input type="number" {...register('year', { required: true })} defaultValue={new Date().getFullYear()} className="w-full px-4 py-2 border rounded-lg" /></div>
        ...
        <div><label className="block text-sm font-medium text-gray-700 mb-1">Total Days</label><input type="number" {...register('totalDays', { required: true })} defaultValue={30} className="w-full px-4 py-2 border rounded-lg" /></div>
        <div><label className="block text-sm font-medium text-gray-700 mb-1">Absent Days</label><input type="number" {...register('absentDays', { required: true })} defaultValue={0} className="w-full px-4 py-2 border rounded-lg" /></div>
